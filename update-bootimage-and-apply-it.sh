...
###################################
# Préparation boot.img pour Open C (service timekeep) et application
...
(
	...
	echo &&
	echo "L'opération a été effectué avec succès ! Vous devez redémarrer votre téléphone pour exécuter le service une première fois."
) ||
